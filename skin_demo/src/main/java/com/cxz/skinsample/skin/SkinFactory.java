package com.cxz.skinsample.skin;
...
import com.cxz.skinsample.widget.ZeroView;
        ...
        public void changeSkin() {
            if (!TextUtils.isEmpty(attrsMap.get("background"))) {//属性名,例如，这个background，text，textColor....
                ...
                if (TextUtils.equals(attrType, "drawable")) {//区分drawable和color
                    view.setBackground(SkinEngine.getInstance().getDrawable(bgId));//加载外部资源管理器，拿到外部资源的drawable
