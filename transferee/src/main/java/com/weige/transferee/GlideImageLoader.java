...
public class GlideImageLoader implements ImageLoader {
    ...
    public void loadSource(final String imageUrl, final SourceCallback callback) {
        ...
        Glide.with(context).download(imageUrl).listener(new RequestListener<File>() {
            ...
            @Override
            public boolean onResourceReady(File resource, Object model, Target<File> target, com.bumptech.glide.load.DataSource dataSource, boolean isFirstResource) {
                if (callback != null)
