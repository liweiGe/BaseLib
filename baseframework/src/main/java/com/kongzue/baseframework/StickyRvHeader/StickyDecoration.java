...
import com.kongzue.baseframework.StickyRvHeader.listener.GroupListener;
 ...
 *                     todo  这个是关键的回调,需要区分组的概念,返回一样的组则代表衣蛾分组,用一个头
 *
 *                         //组名回调
...
public class StickyDecoration extends BaseDecoration {
    ...
    public static class Builder {
        ...
        public Builder setGroupBackground(@ColorInt int background) {
            ...
            mDecoration.mGroutPaint.setColor(background);
            return this;
        }
        ...
        public Builder setGroupTextColor(@ColorInt int color) {
            ...
            mDecoration.mTextPaint.setColor(color);
            return this;
        }
