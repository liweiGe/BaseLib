    ...
    public View getView(final int i, View convertView, ViewGroup viewGroup) {
        switch (dataType) {
            case TYPE_MULTIPLE_DATA:
                ...
                multipleAdapterSettings.setData(multipleData.getType(), multipleViewHolder, multipleData, multipleDatas, i);
                return convertView;
            case TYPE_SIMPLE_DATA:
                ...
                if (layoutResId == -1) {
                    ...
                    simpleAdapterSettings.setData(simpleViewHolder, simpleData, simpleDatas, i);
                }
                return convertView;
            case TYPE_MAP_DATA:
                ...
                if (layoutResIdMap == null) {
                    if (layoutResId == -1) {
                        ...
                        simpleMapAdapterSettings.setData(viewHolder, mapData, mapDatas, i);
                    }
                } else {
                    ...
                    multipleMapAdapterSettings.setData((Integer) mapData.get("type"), viewHolder, mapData, mapDatas, i);
                }
                return convertView;
            default:
                return null;
