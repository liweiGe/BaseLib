...
import com.kongzue.baseframework.asyncChain.lifecycler.iml.ApplicationLifeCycle;
import com.kongzue.baseframework.asyncChain.lifecycler.iml.FragmentLifeCycle;
import com.kongzue.baseframework.asyncChain.lifecycler.iml.SupportFragmentLifeCycle;
...
public class AsyncChainManager implements AsyncChainLifeCycleListener {
    ...
    AsyncChainLifeCycle getLifeCycle(Context context) {
        if (context == null) {
            ...
            return getLifeCycle((Activity) context);
     ...
     * @return
     */
    AsyncChainLifeCycle getLifeCycle(Activity activity) {
        if (activity == null) {
            return mApplicationLifeCycle;
            ...
            return getFragmentLifeCycle(activity, activity.getFragmentManager(), null);
        }
    }
    ...
    AsyncChainLifeCycle getLifeCycle(Fragment fragment) {
        if (fragment == null) {
            ...
            return getSupportFragmentLifeCycle(fragment.getActivity(), fragment.getChildFragmentManager(), fragment);
        }
    }
    ...
    /**
     * 获取一个{@link com.bearever.async.chain.lifecycler.iml.SupportFragmentLifeCycle}
     *
     ...
     *
     * @param activity        宿主activity
     * @param fragmentManager 用于管理Fragment的{@link android.app.FragmentManager}
     * @param parentFragment  宿主fragment
